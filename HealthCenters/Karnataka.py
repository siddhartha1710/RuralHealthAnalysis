...
with open('C:\\Users\\Siddhartha\\PyCharmProjects\\RuralHealthAnalysis\\DataFiles\\Health Centers\\Karnataka.csv','r') as csvfile:
...
plt.title('Karnataka (Health Centers)')
plt.legend()
plt.show()