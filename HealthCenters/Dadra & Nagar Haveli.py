...
with open('C:\\Users\\Siddhartha\\PyCharmProjects\\RuralHealthAnalysis\\DataFiles\\Health Centers\\Dadra & Nagar Haveli.csv','r') as csvfile:
...
plt.xlabel('Dadra & Nagar Haveli')
plt.ylabel('Number')


plt.title('Dadra & Nagar Haveli (Health Centers)')
plt.legend()
plt.show()