...
with open('C:\\Users\\Siddhartha\\PyCharmProjects\\RuralHealthAnalysis\\DataFiles\\Health Centers\\West Bengal.csv','r') as csvfile:
...
plt.xlabel('West Bengal')
plt.ylabel('Number')


plt.title('West Bengal (Health Centers)')
plt.legend()
plt.show()