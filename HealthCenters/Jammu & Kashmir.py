...
with open('C:\\Users\\Siddhartha\\PyCharmProjects\\RuralHealthAnalysis\\DataFiles\\Health Centers\\Jammu & Kashmir.csv','r') as csvfile:
...
plt.xlabel('Jammu & Kashmir')
plt.ylabel('Number')


plt.title('Jammu & Kashmir (Health Centers)')
plt.legend()
plt.show()