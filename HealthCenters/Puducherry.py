...
with open('C:\\Users\\Siddhartha\\PyCharmProjects\\RuralHealthAnalysis\\DataFiles\\Health Centers\\Puducherry.csv','r') as csvfile:
...
plt.xlabel('Puducherry')
plt.ylabel('Number')


plt.title('Puducherry (Health Centers)')
plt.legend()
plt.show()