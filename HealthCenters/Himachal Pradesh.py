...
with open('C:\\Users\\Siddhartha\\PyCharmProjects\\RuralHealthAnalysis\\DataFiles\\Health Centers\\Himachal Pradesh.csv','r') as csvfile:
...
plt.xlabel('Himachal Pradesh')
plt.ylabel('Number')


plt.title('Himachal Pradesh (Health Centers)')
plt.legend()
plt.show()