...
with open('C:\\Users\\Siddhartha\\PyCharmProjects\\RuralHealthAnalysis\\DataFiles\\Health Centers\\Arunachal Pradesh.csv','r') as csvfile:
...
plt.xlabel('Arunachal Pradesh')
plt.ylabel('Number')


plt.title('Arunachal Pradesh (Health Centers)')
plt.legend()
plt.show()