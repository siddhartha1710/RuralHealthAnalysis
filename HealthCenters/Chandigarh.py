...
with open('C:\\Users\\Siddhartha\\PyCharmProjects\\RuralHealthAnalysis\\DataFiles\\Health Centers\\Chandigarh.csv','r') as csvfile:
...
plt.xlabel('Chandigarh')
plt.ylabel('Number')


plt.title('Chandigarh (Health Centers)')
plt.legend()
plt.show()