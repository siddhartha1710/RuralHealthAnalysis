...
with open('C:\\Users\\Siddhartha\\PyCharmProjects\\RuralHealthAnalysis\\DataFiles\\Health Centers\\Lakshadweep.csv','r') as csvfile:
...
plt.xlabel('Lakshadweep')
plt.ylabel('Number')


plt.title('Lakshadweep (Health Centers)')
plt.legend()
plt.show()