...
label=[]
with open('C:\\Users\\Siddhartha\\PyCharmProjects\\RuralHealthAnalysis\\DataFiles\\Health Centers\\Uttar Pradesh.csv','r') as csvfile:
...
plt.xlabel('Uttar Pradesh')
plt.ylabel('Number')


plt.title('Uttar Pradesh (Health Centers)')
plt.legend()
plt.show()