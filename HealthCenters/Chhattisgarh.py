...
with open('C:\\Users\\Siddhartha\\PyCharmProjects\\RuralHealthAnalysis\\DataFiles\\Health Centers\\Chhattisgarh.csv','r') as csvfile:
...
plt.xlabel('Chhattisgarh')
plt.ylabel('Number')


plt.title('Chhattisgarh (Health Centers)')
plt.legend()
plt.show()