...
with open('C:\\Users\\Siddhartha\\PyCharmProjects\\RuralHealthAnalysis\\DataFiles\\Health Centers\\Andhra Pradesh.csv','r') as csvfile:
...
plt.title('Andhra Pradesh (Health Centers)')
plt.legend()
plt.show()