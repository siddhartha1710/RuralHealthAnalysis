...
y5 = []
label=[]
with open('C:\\Users\\Siddhartha\\PyCharmProjects\\RuralHealthAnalysis\\DataFiles\\Health Centers\\Jharkhand.csv','r') as csvfile:
...
plt.xlabel('Jharkhand')
plt.ylabel('Number')


plt.title('Jharkhand (Health Centers)')
plt.legend()
plt.show()