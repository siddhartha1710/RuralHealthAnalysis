...
with open('C:\\Users\\Siddhartha\\PyCharmProjects\\RuralHealthAnalysis\\DataFiles\\Health Centers\\Daman & Diu.csv','r') as csvfile:
...
plt.xlabel('Daman & Diu')
plt.ylabel('Number')


plt.title('Daman & Diu (Health Centers)')
plt.legend()
plt.show()