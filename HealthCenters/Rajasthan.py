...
with open('C:\\Users\\Siddhartha\\PyCharmProjects\\RuralHealthAnalysis\\DataFiles\\Health Centers\\Rajasthan.csv','r') as csvfile:
...
plt.title('Rajasthan (Health Centers)')
plt.legend()
plt.show()