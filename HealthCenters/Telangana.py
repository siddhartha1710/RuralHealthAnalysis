...
with open('C:\\Users\\Siddhartha\\PyCharmProjects\\RuralHealthAnalysis\\DataFiles\\Health Centers\\Telangana.csv','r') as csvfile:
...
plt.xlabel('Telangana')
plt.ylabel('Number')


plt.title('Telangana (Health Centers)')
plt.legend()
plt.show()