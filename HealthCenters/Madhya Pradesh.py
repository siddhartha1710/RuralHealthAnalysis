...
with open('C:\\Users\\Siddhartha\\PyCharmProjects\\RuralHealthAnalysis\\DataFiles\\Health Centers\\Madhya Pradesh.csv','r') as csvfile:
...
plt.xlabel('Madhya Pradesh')
plt.ylabel('Number')


plt.title('Madhya Pradesh (Health Centers)')
plt.legend()
plt.show()