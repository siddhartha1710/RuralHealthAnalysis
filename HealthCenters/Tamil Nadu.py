...
with open('C:\\Users\\Siddhartha\\PyCharmProjects\\RuralHealthAnalysis\\DataFiles\\Health Centers\\Tamil Nadu.csv','r') as csvfile:
...
plt.xlabel('Tamil Nadu')
plt.ylabel('Number')


plt.title('Tamil Nadu (Health Centers)')
plt.legend()
plt.show()