...
with open('C:\\Users\\Siddhartha\\PyCharmProjects\\RuralHealthAnalysis\\DataFiles\\Health Centers\\Uttarakhand.csv','r') as csvfile:
...
plt.title('Uttarakhand (Health Centers)')
plt.legend()
plt.show()